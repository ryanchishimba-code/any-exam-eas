 ...
 * Same chrome as Library cards, on the study teal surface.
 */
export function ItemProvenanceNote({
  ...
  return (
    <div
      ...
      className="mt-3 rounded-2xl border border-[var(--study-accent)]/25 bg-[var(--color-surface)] px-3 py-2.5 text-[13px] leading-snug tracking-tight text-[var(--color-ink)]"
    >
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0">
          ...
          {reviewedLabel ? (
            <p className="mt-1 text-xs text-[var(--color-ink-muted)]">Reviewed {reviewedLabel}</p>
          ) : null}
        </div>
      </div>
    </div>
