    ...
    <div className="fixed inset-0 z-[100] flex items-end justify-center lg:hidden">
      ...
      <div
        ...
        className={cn(
          ...
          "relative z-10 flex max-h-[min(88vh,640px)] w-full flex-col overflow-hidden rounded-t-[28px] border border-white/[0.08] bg-[var(--anatomy-panel-elevated)] shadow-[0_-12px_48px_rgba(0,0,0,0.5)] backdrop-blur-xl"
        )}
      >
