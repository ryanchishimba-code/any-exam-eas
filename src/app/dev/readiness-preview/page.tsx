...
const board: ReadinessPageData = {
  ...
  result: {
    ...
    summaryLine: "On track in 6 of 8 areas. Focus next on Pharmacological Therapies and Safety & Infection Control.",
  ...
  history: [
    ...
    },
    {
      ...
      summaryLine: "On track in 2 of 8 areas. Focus next on Pharmacological Therapies and Safety & Infection Control.",
      correctCount: 10,
      answeredCount: 24,
    },
  ],
  baselineSummary: "On track in 2 of 8 areas. Focus next on Pharmacological Therapies and Safety & Infection Control.",
