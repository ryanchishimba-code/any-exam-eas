  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[var(--color-bg)]">
        <section className="relative overflow-hidden px-6 pt-[var(--page-top)] pb-12 sm:pb-16">
          <div
            className="pointer-events-none absolute inset-x-0 top-0 h-[320px] bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,color-mix(in_srgb,var(--color-accent)_12%,transparent),transparent)]"
            aria-hidden
          />
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            <h1 className="apple-display mt-4 text-[clamp(2.25rem,5.5vw,3.25rem)] leading-[1.08]">
        ...
        >
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-center text-sm leading-relaxed text-[var(--color-ink-muted)]">
                ...
                return (
                  ...
                  >
                    <Link
                      ...
                      className="text-lg font-bold text-[var(--color-ink)] hover:text-[var(--color-accent)]"
                    >
                      {label} →
                    </Link>
                    {articles.length > 0 ? (
        ...
        <section className="px-6 py-14 sm:py-16" aria-labelledby="toolkit-product-heading">
          <div className="mx-auto max-w-6xl">
            <h2
        ...
        <section
          className="border-t border-[var(--color-border)] bg-[var(--color-surface)] px-6 py-14 sm:py-16"
        ...
        >
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-8 max-w-3xl text-[11px] leading-relaxed text-[var(--color-ink-muted)]">
              {BOARD_DISCLAIMER}
            </p>
          </div>
        </section>

        <section className="border-t border-[var(--color-border)] px-6 py-12 sm:py-14">
