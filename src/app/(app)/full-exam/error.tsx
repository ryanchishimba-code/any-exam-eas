...
export default function FullExamError({
  error,
  reset,
}: {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4 px-6 py-16 text-center">
      <h1 className="text-xl font-semibold text-[var(--color-ink)]">Exam simulator unavailable</h1>
      <p className="text-sm leading-relaxed text-[var(--color-ink-muted)]">
        We could not load the full exam simulator. This is usually a brief database connection blip —
