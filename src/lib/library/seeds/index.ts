...
import { buildReviewModulePadCards } from "./cards-from-review-modules";

const PADDED_MEMORY_CARDS = [
  ...RAW_MEMORY_CARDS,
  ...buildReviewModulePadCards(RAW_MEMORY_CARDS),
];

export const MEMORY_CARDS = enrichMemoryCards(PADDED_MEMORY_CARDS);
