...
export const WEAK_AREA_MEMORY_CARD_MAP: Record<string, string[]> = {
  ...
  prioritization: [
    "nclex-pri-abc-first",
    "nclex-pri-see-first",
    "nclex-pri-assess-act",
    "nclex-pri-trap-eventually",
    "nclex-pri-room-parse",
    "nclex-pri-transfusion",
  ],
  postpartum: [
    "nclex-mat-pph-fundus",
    "nclex-mat-preeclampsia",
    "nclex-mat-mag-toxicity",
    "nclex-mat-late-decel",
    "nclex-mat-variable-decel",
    "nclex-mat-category-3",
  ],
  "medication-safety": [
    "nclex-pharm-insulin-never",
    "nclex-pharm-hypo-15",
    "nclex-pharm-pca-rr",
    "nclex-pharm-k-never-push",
    "nclex-pharm-warfarin-inr",
    "nclex-pharm-calc-units",
  ],
  psychiatric: [
    "nclex-psych-suicide-ask",
    "nclex-psych-no-secrecy",
    "nclex-psych-therapeutic-open",
    "nclex-psych-restraint-last",
    "nclex-psych-ciwa",
    "nclex-psych-lithium-monitor",
  ],
  electrolytes: [
    "nclex-elec-k-peaked-t",
    "nclex-elec-k-u-wave",
    "nclex-elec-hyponatremia-slow",
    "nclex-elec-chvostek",
    "nclex-elec-mg-reflexes",
    "nclex-elec-dka-k-shift",
  ],
  pediatrics: [
    "nclex-peds-infant-fever",
    "nclex-peds-dehydration",
    "nclex-peds-weight-dose",
    "nclex-peds-no-aspirin",
    "nclex-peds-abuse-report",
    "nclex-peds-vs-adult-vitals",
  ...
  "legal-ethical": [
    "nclex-legal-consent-rn",
    "nclex-legal-refuse-blood",
    "nclex-legal-mandatory-report",
    "nclex-legal-unsafe-assign",
    "nclex-legal-hipaa-min",
    "nclex-legal-impaired-colleague",
  ],
  delegation: [
    "nclex-five-rights",
    "nclex-never-delegate",
