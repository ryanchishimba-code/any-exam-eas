...
const BASE_MODULES: AnatomyModuleDef[] = [
  { id: "skull", layer: "bone", position: [0, 1.55, 0.02], scale: [0.38, 0.4, 0.38], color: ORGAN_COLORS.boneAccent, geometry: "sphere", profile: "skull", focusDistance: 1.55, opacity: 0.95 },
  { id: "brain", layer: "organ", position: [0, 1.52, 0.04], scale: [0.28, 0.24, 0.3], color: ORGAN_COLORS.brain, geometry: "sphere", profile: "brain", focusDistance: 1.45 },
  ...
  { id: "clavicle", layer: "bone", position: [0, 1.26, 0.06], scale: [0.42, 0.045, 0.045], color: ORGAN_COLORS.boneAccent, geometry: "box", profile: "clavicle-pair", focusDistance: 1.5 },
  ...
  { id: "sternum", layer: "bone", position: [0, 0.9, 0.09], scale: [0.05, 0.22, 0.025], color: ORGAN_COLORS.boneAccent, geometry: "box", focusDistance: 1.45 },
  { id: "aorta", layer: "vascular", position: [0.02, 1.0, -0.03], scale: [0.1, 0.16, 0.1], color: ORGAN_COLORS.artery, geometry: "cylinder", profile: "aorta-arch", focusDistance: 1.4, metalness: 0.1 },
  ...
  { id: "appendix", layer: "organ", position: [-0.14, 0.24, 0.04], scale: [0.04, 0.08, 0.035], color: ORGAN_COLORS.colon, geometry: "capsule", profile: "appendix-tube", focusDistance: 1.35 },
  ...
  { id: "prostate", layer: "organ", position: [0, 0, 0.02], scale: [0.08, 0.045, 0.06], color: ORGAN_COLORS.prostate, geometry: "sphere", focusDistance: 1.25 },
  ...
  { id: "vertebral-column", layer: "bone", position: [0, 0.5, -0.16], scale: [0.06, 0.85, 0.06], color: ORGAN_COLORS.boneAccent, geometry: "cylinder", profile: "vertebrae", focusDistance: 1.85 },
  { id: "scapula", layer: "bone", position: [-0.28, 1.0, -0.09], scale: [0.1, 0.14, 0.035], color: ORGAN_COLORS.boneAccent, geometry: "box", profile: "scapula-blade", rotation: [0, 0.3, 0], focusDistance: 1.5 },
  ...
  { id: "humerus", layer: "bone", position: [0.38, 0.4, 0.01], scale: [0.05, 0.32, 0.05], color: ORGAN_COLORS.boneAccent, geometry: "capsule", profile: "long-bone", focusDistance: 1.45 },
  { id: "femur", layer: "bone", position: [0.11, -0.1, 0.01], scale: [0.085, 0.46, 0.085], color: ORGAN_COLORS.boneAccent, geometry: "capsule", profile: "long-bone", focusDistance: 2.0 },
  { id: "tibia", layer: "bone", position: [0.11, -0.6, 0.02], scale: [0.06, 0.34, 0.06], color: ORGAN_COLORS.boneAccent, geometry: "capsule", profile: "long-bone", focusDistance: 2.05 },
];

export const ANATOMY_MODULES: AnatomyModuleDef[] = BASE_MODULES.map(withLayout);
