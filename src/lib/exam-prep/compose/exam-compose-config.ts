...
const CONFIGS: Record<string, ExamComposeConfig> = {
  ...
  "usmle-step-1": {
    ...
    boardReference: "USMLE Step 1 Content Outline — systems + physician competencies",
    minutesPerItem: 1.5,
  ...
  "usmle-step-2": {
    ...
    boardReference: "USMLE Step 2 CK Content Outline — disciplines + competencies",
    minutesPerItem: 1.5,
  ...
  "usmle-step-3": {
    ...
    boardReference: "USMLE Step 3 Content Outline — clinical encounter frames",
    minutesPerItem: 1.5,
