...
export const NCLEX_2026_TOPIC_KEYWORDS: { slug: string; pattern: RegExp }[] = [
  ...
  { slug: "disaster-triage", pattern: /\bSTART triage|\bmass casualty|\btriage tag/i },
  ...
  { slug: "dosage-calculations", pattern: /\bdrip rate|\bmL\/hr|\breconstitut|\bmg\/kg/i },
  { slug: "interactions-antidotes", pattern: /\bNarcan|\bnaloxone|\bDigibind|\bvitamin K|\bprotamine/i },
  { slug: "blood-products-transfusion", pattern: /\btransfusion reaction|\bhemolytic|\btype and cross/i },
  ...
  { slug: "burns-trauma", pattern: /\bburn(?:s)? (?:patient|victim)|\bParkland|\bTBSA/i },
];
