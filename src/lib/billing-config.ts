...
export const MONTHLY_PRICE_USD = Number(process.env.PRO_MONTHLY_PRICE_USD ?? process.env.MONTHLY_PRICE_USD ?? "34");
...
export const YEARLY_PRICE_USD = Number(process.env.PRO_YEARLY_PRICE_USD ?? process.env.YEARLY_PRICE_USD ?? "340");
