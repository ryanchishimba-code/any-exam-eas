...
export const NPTE_PT_TOPIC_MODULES: TopicModuleDefinition[] = [
  ...
  },
  {
    ...
    overview: "BPPV repositioning, gaze stabilization, and fall prevention after vestibular loss.",
    skills: ["assess", "next_step"],
    estimatedMinutes: 30,
    reviewTopicSlug: "npte-vestibular-balance",
    questions: { practiceTopicSlug: "neuromuscular-nervous", reviewCount: 15, curatedOnly: true },
    tags: ["vestibular", "balance", "high-yield"],
    sortOrder: 4,
  },
  {
    id: "npte-lifespan",
    ...
    overview: "CP, torticollis, falls prevention, frailty, and acute care modifiers across systems.",
    skills: ["assess", "next_step"],
    estimatedMinutes: 30,
    reviewTopicSlug: "npte-peds-geriatrics",
    questions: { practiceTopicSlug: "system-interactions", reviewCount: 15, curatedOnly: true },
    tags: ["pediatrics", "geriatrics", "lifespan"],
    sortOrder: 5,
  },
  {
    id: "npte-safety",
    ...
    overview: "Referral criteria, exercise contraindications, infection control, and fall risk assessment.",
    skills: ["assess", "next_step"],
    estimatedMinutes: 25,
    reviewTopicSlug: "npte-safety-red-flags",
    questions: { practiceTopicSlug: "safety-protection", reviewCount: 12, curatedOnly: true },
    tags: ["safety", "red-flags", "high-yield"],
    sortOrder: 6,
  },
  {
    id: "npte-board-block",
