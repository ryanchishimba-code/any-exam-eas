...
/** Builds an 8-section NAPLEX textbook-style review module. */
export function buildNaplexReviewModule(input: NaplexModuleInput): ReviewModuleContent {
  return {
    sections: [
