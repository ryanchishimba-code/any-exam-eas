...
export const LEGAL_DISCLAIMERS = {
  ...
  subscription:
    "You may start a free app trial without providing a payment method. Trial access includes a limited number of practice questions and full Pro features as described at signup. A valid payment method is required when you upgrade to a paid Pro subscription. Paid subscriptions renew automatically on your saved payment method at the price and billing interval you selected unless canceled before renewal.",
  ...
  planChanges:
    "During a free trial, you may upgrade to Pro at any time. When you subscribe, billing for your Pro plan begins at checkout. After your trial ends without subscribing, your account automatically moves to the Free tier with limited question access.",
