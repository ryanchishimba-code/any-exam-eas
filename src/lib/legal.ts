...
export const LEGAL_DISCLAIMERS = {
  ...
  contentProvider: `${LEGAL_ENTITY.productName} practice questions, mock exams, explanations, and study materials are authored, curated, and/or generated by ${LEGAL_ENTITY.companyName}, which operates ${LEGAL_ENTITY.productName}. The Company is solely responsible for this content.`,

  notOfficialExamContent:
    "Content labeled for NCLEX®, USMLE®, NAPLEX®, PANCE®, NPTE®, AANP FNP®, or other exams is original study material for educational and self-assessment purposes only. It is NOT actual, past, current, or future official board or licensing examination content and must not be relied upon as a substitute for official prep materials from examination authorities or accredited publishers.",

  supplementaryStudyRequired:
    "Passing licensure or certification examinations typically requires multiple study sources—including textbooks, accredited review courses, clinical experience, and official prep resources. Any Exam Easy is a supplement, not a sole or guaranteed path to exam success. You are responsible for using additional authoritative materials as needed.",
