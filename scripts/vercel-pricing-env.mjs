...
const KEYS = [
  ...
  "FREE_TIER_LIFETIME_QUESTIONS",
];

const DEFAULTS = {
  PRO_MONTHLY_PRICE_USD: "27.99",
  PRO_YEARLY_PRICE_USD: "235.12",
  MONTHLY_PRICE_USD: "27.99",
  BASIC_MONTHLY_PRICE_USD: "27.99",
  BASIC_YEARLY_PRICE_USD: "235.12",
  TRIAL_DAYS: "5",
  TRIAL_LIFETIME_QUESTIONS: "500",
  FREE_TIER_LIFETIME_QUESTIONS: "0",
};
