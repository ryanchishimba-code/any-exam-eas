...
const KEYS = [
  ...
  { key: "STRIPE_BASIC_PRICE_ID_MONTHLY", sensitive: false },
  { key: "STRIPE_BASIC_PRICE_ID_QUARTERLY", sensitive: false },
  { key: "STRIPE_BASIC_PRICE_ID_SEMIANNUAL", sensitive: false },
  { key: "STRIPE_BASIC_PRICE_ID_YEARLY", sensitive: false },
  { key: "STRIPE_PRO_PRICE_ID_MONTHLY", sensitive: false },
  { key: "STRIPE_PRO_PRICE_ID_QUARTERLY", sensitive: false },
  { key: "STRIPE_PRO_PRICE_ID_SEMIANNUAL", sensitive: false },
  { key: "STRIPE_PRO_PRICE_ID_YEARLY", sensitive: false },
  { key: "STRIPE_PRICE_ID", sensitive: false, optional: true },
  { key: "STRIPE_PRICE_ID_QUARTERLY", sensitive: false, optional: true },
  ...
  { key: "PRO_YEARLY_PRICE_USD", sensitive: false, optional: true },
  { key: "MONTHLY_PRICE_USD", sensitive: false, optional: true },
