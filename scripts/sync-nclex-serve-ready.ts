#!/usr/bin/env node
/**
 * Sync NCLEX bank for production serve: qaPassed ↔ best-tier pool,
 * valid subjectId/topicCategory, and study cross-links (review topics, Top 500 drugs).
 *
 * Usage:
 *   npm run db:sync-nclex-serve-ready
 *   npm run db:sync-nclex-serve-ready -- --dry-run
 *   npm run db:sync-nclex-serve-ready -- --retire-non-best
 *   npm run db:sync-nclex-serve-ready -- --retire-non-best --retire-only
 */
